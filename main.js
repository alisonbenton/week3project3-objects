...
document.getElementById("q4").innerHTML = "Penny's dinner choice is: " + invitees.adults[0].dinnerChoice[1];
...
document.getElementById("q6").innerHTML = "Lauren's seating choice is: " + invitees.adults[2].specialConsiderations.seating;

// 7. Access Billy's dessert choice (this will be the third item in his dinnerChoice array)

document.getElementById("q7").innerHTML = "Billy's dessert choice is: " + invitees.adults[1].dinnerChoice[2];


// 8. Access Ada's allergies.

document.getElementById("q8").innerHTML = "Ada's allergies are: " + invitees.children[2].allergies;
...
jsWorkshop.classmates = ["Kelly", "Dan", "James", "Justyna", "Greg"];

// 12. Get the length of the fourth classmate's name.

document.getElementById("q12").innerHTML = "The fourth classmate's name has a length of: " + jsWorkshop.classmates[3].length;
...
books.ISBN001 = {title: "Dishwashers and Kites", author: "Joe Shmoe", pages: "17"};
books.ISBN002 = {title: "Bed Linens and Oranges", author: "Regina Yellen", pages: "202"};
books.ISBN003 = {title: "Congress and a Butterfly", author: "Sally Smith", pages: "121"};

// C. Access the author of the first book.

document.getElementById("qc").innerHTML = "The author of the first boook is: " + books.ISBN001.author;


// D. Get the length of the author the the third book.

document.getElementById("qd").innerHTML = "The third author's name has a length of: " + books.ISBN003.author.length;


// E. To each book object variable, add a key of "dateRead" with a value of the year you read the book.
//     (Go ahead and make this up, too. Get wild.)

books.ISBN001.dateRead = 2012;
books.ISBN002.dateRead = 2013;
books.ISBN003.dateRead = 2014;

// F. Remove the second book from the books object.

delete books.ISBN002;


// G. Explain, in your own words, the difference between Literal Notation and Constructor Notation.
document.getElementById("qg").innerHTML =  "In Literal Notation, you assemble the object when you define it whereas in Constructor Notation we manipulate the object and its properties after defining it.";
